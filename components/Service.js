import { ChartBarIcon, ChartPieIcon, PresentationChartLineIcon } from '@heroicons/react/outline'
...
function Service({ heading, paragraph, icon, variants }) {
  function getIcon() {
    if(icon === 'chart') {
      ...
      return <PresentationChartLineIcon className="h-10 w-10 mx-auto bg-palette-lighter p-2 rounded-lg text-palette-primary" />
    }
  }
