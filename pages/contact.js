...
export default function ContactPage() {
    ...
    return <div className="container mx-auto py-6 sm:py-12">
        ...
        <form onSubmit={ handleSubmit }
              className="w-full px-4 py-12 mx-auto max-w-2xl font-secondary">

            <label className="block mb-2 text-xs font-bold uppercase text-gray-900"
                   htmlFor="first-name">
                Name
            </label>

            <input className="w-full mb-6 form-input border border-gray-300 rounded-lg p-2
